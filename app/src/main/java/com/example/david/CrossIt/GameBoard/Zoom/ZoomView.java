...
public class ZoomView extends FrameLayout {
    ...
    public void smoothZoomTo(float zoom) {
        smoothZoomTo(zoom,smoothZoomX, 0);
        ...
        switch(ev.getAction()) {
            ...
            case 4:
                if(l < 30.0F) {
                    if(System.currentTimeMillis() - this.lastTapTime < 500L) {
                        ...
                        if(this.smoothZoom < 2.0F) {
                            this.smoothZoomTo(this.maxZoom, x, y);
                        } else {
                            this.smoothZoomTo(1.9F, (float)this.getWidth() / 2.0F, (float)this.getHeight() / 2.0F);
                        }
            ...
            case 2:
                if(this.scrolling || this.smoothZoom > 1.0F && l > 30.0F) {
                    ...
                    //Scrolling speed
                    this.smoothZoomX -= (dx / this.zoom)*4;
                    //this.smoothZoomX=0.f;
                    this.smoothZoomY -= (dy / this.zoom)*4;
                   // this.smoothZoomY=0.f;
                    return;
                }
            case 3:
        }
